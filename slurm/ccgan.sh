...
#SBATCH --job-name=wafer_ccgan_job
#SBATCH --time=12:00:00
#SBATCH --ntasks=8
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/scratch/general/vast/u1475870/wafer_project/logs/%j/%j_ccgan.out
#SBATCH --error=/scratch/general/vast/u1475870/wafer_project/logs/%j/%j_ccgan.err
...
cp /uufs/chpc.utah.edu/common/home/$USER/wafer_project/ccgan.py .
...
python ccgan.py > $LOG_DIR/ccgan_output.txt 2>&1
