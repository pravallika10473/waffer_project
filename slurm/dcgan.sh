...
#SBATCH --job-name=wafer_dcgan_job
...
cp /uufs/chpc.utah.edu/common/home/$USER/wafer_project/dcgan.py .
...
python dcgan.py > $LOG_DIR/dcgan_output.txt 2>&1

# Deactivate the Conda environment
conda deactivate

# Copy results back to the home directory
cp $SCRATCH_DIR/outputs/dcgan_generator.pth /uufs/chpc.utah.edu/common/home/$USER/wafer_project/outputs/
cp $SCRATCH_DIR/outputs/dcgan_discriminator.pth /uufs/chpc.utah.edu/common/home/$USER/wafer_project/outputs/
cp $SCRATCH_DIR/outputs/dcgan_images/ /uufs/chpc.utah.edu/common/home/$USER/wafer_project/outputs/
cp $LOG_DIR/dcgan_output.txt /uufs/chpc.utah.edu/common/home/$USER/wafer_project/outputs/
